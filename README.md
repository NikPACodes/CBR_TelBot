...
- [CBR Telegram Bot](#cbr-telegram-bot)
  ...
  - [Установка и запуск](#установка-и-запуск)
    ...
    - [2. Настройка конфигураций _(config.py)_](#2-настройка-конфигураций-configpy)
    - [3. Запустить бота](#3-запустить-бота)
...
## Особенности
:exclamation: Для работы данного бота необходимо подключение базы данных PostgeSQL.
- При запуске проекта создается структура БД PosgreSQL необходимая для работы бота  
...
| Файл                  | Описание                                                |
|-----------------------|---------------------------------------------------------|
| config.py             | Конфигурация: токен бота и параметры для подключения БД |
...
### 2. Настройка конфигураций _(config.py)_
- Необходимо заполнить файл config.py собственными данными:
  ```
